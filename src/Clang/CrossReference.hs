...
constructUSR_ObjCClass :: ClangBase m => String -> ClangT s m (FFI.ClangString s)
constructUSR_ObjCClass = FFI.constructUSR_ObjCClass

constructUSR_ObjCCategory :: ClangBase m => String -> String -> ClangT s m (FFI.ClangString s)
constructUSR_ObjCCategory = FFI.constructUSR_ObjCCategory

constructUSR_ObjCProtocol :: ClangBase m => String -> ClangT s m (FFI.ClangString s)
constructUSR_ObjCProtocol = FFI.constructUSR_ObjCProtocol

constructUSR_ObjCIvar :: ClangBase m => String -> FFI.ClangString s' -> ClangT s m (FFI.ClangString s)
constructUSR_ObjCIvar = FFI.constructUSR_ObjCIvar

constructUSR_ObjCMethod :: ClangBase m => String -> Bool -> FFI.ClangString s' -> ClangT s m (FFI.ClangString s)
constructUSR_ObjCMethod = FFI.constructUSR_ObjCMethod

constructUSR_ObjCProperty :: ClangBase m => String -> FFI.ClangString s' -> ClangT s m (FFI.ClangString s)
