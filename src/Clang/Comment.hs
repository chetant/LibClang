...
textComment_getText :: ClangBase m => FFI.Comment s' -> ClangT s m (FFI.ClangString s)
textComment_getText = FFI.textComment_getText

inlineCommandComment_getCommandName :: ClangBase m => FFI.Comment s' -> ClangT s m (FFI.ClangString s)
...
htmlTagComment_getTagName :: ClangBase m => FFI.Comment s' -> ClangT s m (FFI.ClangString s)
...
htmlStartTag_getAttrs :: ClangBase m => FFI.Comment s' -> ClangT s m [(FFI.ClangString s, FFI.ClangString s)]
...
blockCommandComment_getCommandName :: ClangBase m => FFI.Comment s' -> ClangT s m (FFI.ClangString s)
...
paramCommandComment_getParamName :: ClangBase m => FFI.Comment s' -> ClangT s m (FFI.ClangString s)
...
tParamCommandComment_getParamName :: ClangBase m => FFI.Comment s' -> ClangT s m (FFI.ClangString s)
...
verbatimBlockLineComment_getText :: ClangBase m => FFI.Comment s' -> ClangT s m (FFI.ClangString s)
verbatimBlockLineComment_getText = FFI.verbatimBlockLineComment_getText

verbatimLineComment_getText :: ClangBase m => FFI.Comment s' -> ClangT s m (FFI.ClangString s)
verbatimLineComment_getText = FFI.verbatimLineComment_getText

htmlTagComment_getAsString :: ClangBase m => FFI.Comment s' -> ClangT s m (FFI.ClangString s)
htmlTagComment_getAsString = FFI.hTMLTagComment_getAsString

fullComment_getAsHTML :: ClangBase m => FFI.Comment s' -> ClangT s m (FFI.ClangString s)
fullComment_getAsHTML = FFI.fullComment_getAsHTML

fullComment_getAsXML :: ClangBase m => FFI.Comment s' -> ClangT s m (FFI.ClangString s)
